...
python/                 collatz_maxodd — cycle search, sieves, backward tree,
                        ...
                        either end, 3-adic witness, cycle structure; 235 tests
lean/                   Collatz — Mathlib-free Lean 4 development, 0 sorry,
                        0 axioms beyond propext/Quot.sound, 274 audited decls
...
axiom audit (274 declarations: 219 on `[propext, Quot.sound]`, 29 on `[propext]`,
26 on none; no `sorryAx`, no `Classical.choice`), a coverage check that every
