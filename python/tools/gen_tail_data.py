...
print()
print("a_k computed exactly to k = 23 by the 3-adic tree DFS")
print("(collatz_maxodd.deathdepth.surviving_residue_count):")
print("  ..., 10995110, 26812105, 69626820, 182840849")
print("The tail RATE is bracketed 0.896 <= rate <= 0.947 and is NOT confirmed;")
print("see docs/DEATH_DEPTH.md for why k ~ 33 would be needed to settle it.")
