...
Plus: 228 Python tests over the 2127-cycle census; 1623 real `S_q` cycles
...
Lean 4.33.1, **no Mathlib**, `"packages": []`. 262 declarations audited:
211 depend on `[propext, Quot.sound]`, 29 on `[propext]`, 22 on nothing. Zero
...
Lean total: **262 declarations**, all certifying `[propext, Quot.sound]` or
